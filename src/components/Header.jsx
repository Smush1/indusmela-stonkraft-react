  ...
  return (
      <header>
        ...
        <div className="container-fluid d-flex align-items-center justify-content-between">
          ...
          {/*   <!-- Centered Logo --> */}
            <a className="navbar-brand mx-auto" href="#" rel="noreferrer">
                <img src={logo} alt="StonKraft" className="logo-img" />
            </a>

        {/*     <!-- Right-aligned Button --> */}
            <a href="#bulk-buy" rel="noreferrer" className="d-lg-block d-none corporate-btn">CONTACT FOR BULK BUYING</a>
        </div>
        </nav>
      </header>
  )
